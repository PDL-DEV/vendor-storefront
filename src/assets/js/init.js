...
var jampack = function () {
  ...
  $(document).on(
    "click",
    '[data-layout="twocolumn"] .main-menu .menu-content-wrap .nav-link',
    function (e) {
  ...
  $(document).on(
    "click",
    '[data-layout="twocolumn"] #hk_menu_backdrop,[data-layout="twocolumn"] .hk-pg-wrapper,[data-layout="twocolumn"] .hk-navbar,[data-layout="twocolumn"] .hk-section-nav',
    function (e) {
      $wrapper.removeAttr("data-submenu");
  ...
  $(document).on(
    "click",
    '[data-layout="twocolumn"] .navbar-toggle',
    function (e) {
  ...
  /*Togglable Js*/
  $(".hk-navbar-togglable").on("click", function (e) {    
...
var invoiceApp = function () {
  $(document).on(
    ...
    function (e) {      
      invoiceAppTarget.addClass("invoiceapp-sidebar-toggle");
  ...
  $(document).on(
    ...
    function (e) {      
      invoiceAppTarget.removeClass("invoiceapp-sidebar-toggle");
  ...
  $(document).on(
    "click",
    ".invoiceapp-setting-toggle.active,.info-close",
    function (e) {
...
$(window).on("resize", function () {
  ...
  if (
    width > 1199 &&
    $wrapper.attr("data-layout-style") == "offcanvas" &&
    $wrapper.attr("data-layout") == "twocolumn"
  )
    $wrapper.removeAttr("data-layout-style");
  if (
    (width <= 1199 &&
      $wrapper.attr("data-layout") == "twocolumn" &&
      $wrapper.attr("data-submenu") == "active") ||
    (width > 1199 && $wrapper.attr("data-submenu") == "active")
  )
    $wrapper.removeAttr("data-submenu");
...
$(document).on("click", ".header-wth-search .btn-search-toggle", function (e) {
  ...
  $(this)
    .closest(".header-wth-search")
    .find(".nav-search, >div:first-child")
    .addClass("d-flex");
  $(this)
    .closest(".header-wth-search")
